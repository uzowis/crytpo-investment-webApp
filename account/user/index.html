...
<input id="exampleuser1" type="email" placeholder="Email" name="username" class="form-control" required="">
...
<a href="register.html" class="pull-right">Create an Account</a>
<hr>
...
<a href="forgot_password.html" class="btn btn-danger btn-rounded">I forgot my password</a>
</div>
        </div>
    </div>
