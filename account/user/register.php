...
<input class="form-control" type="text" name="username" placeholder="Enter Username" required="">
   ...
   <input type="hidden" name="referrer" value=" " placeholder="Confirm Password" >
    <div class="row">
<div class="col-sm-6">
<div class="form-group">
...
<input class="form-control" type="text" name="sq" placeholder="Password" required="">
...
<input class="form-control" type="text" name="sa" placeholder="Confirm Password" required=""> 
</div>
</div>
</div>
...
<input class="form-control" type="text" name="bitcoin" placeholder="Enter your Bitcoin Wallet Address">
...
<div class="buttons-w">
 ...
 <a href="index.html" class="pull-right">Member Login</a>
</div>
</form>
