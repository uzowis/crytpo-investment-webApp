...
<div class="value"><?php echo $result2.' <span style="font-size:12px;"> USERS</span>'; ?></div><br>
...
<?php 
$query3 = mysqli_query($db, "SELECT * FROM investment WHERE status='active'");
$result3 = mysqli_num_rows($query3);
$details3 = mysqli_fetch_assoc($query3);

$query4 = mysqli_query($db, "SELECT SUM(amount) AS invested_sum FROM investment");
$details4 = mysqli_fetch_assoc($query4);
$invested_sum = $details4['invested_sum'];

$query5 = mysqli_query($db, "SELECT SUM(amount) AS deposit_sum FROM deposit WHERE status='confirmed'");
$result5 = mysqli_num_rows($query5);
$details5 = mysqli_fetch_assoc($query5);
$deposit_sum = $details5['deposit_sum'];

$query6 = mysqli_query($db, "SELECT SUM(amount) AS withdrawal_sum FROM withdrawal WHERE status='confirmed'");
...
<a class="element-box el-tablo" href="#">
<div class="label">Total Active Investments</div>
<div class="value"><?php echo $result3.' <span style="font-size:12px;"> INVESTMENTS</span>'; ?></div><br>
<div class="trending trending-up-basic">
<span>&nbsp;</span>
<i class="fa fa-clock-o">
</i>
...
<div class="value"><?php if ($invested_sum<=0){echo '$0.00';}else{echo '$'.$invested_sum.".00";}  ?></div><br>
<div class="trending trending-up-basic">
<span>&nbsp;</span>
<i class="fa fa-clock-o">
</i>
...
<div class="value"><?php if ($deposit_sum <= 0){echo '$0.00';}else{echo '$'.$deposit_sum;} ?></div><br>
<div class="trending trending-up-basic">
<span>&nbsp;</span>
<i class="fa fa-clock-o">
</i>
...
<div class="value"><?php if ($withdrawal_sum <= 0){echo '$0.00';}else{echo '$'.$withdrawal_sum;}?></div><br>
...
<?php 
$query3 = mysqli_query($db, "SELECT * FROM deposit ORDER BY id DESC LIMIT 7");
$result3 = mysqli_num_rows($query3);
