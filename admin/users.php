...
<h6 class="element-header">Registered Users</h6>
...
<th class="sorting" tabindex="0" aria-controls="dataTable1" rowspan="1" colspan="1" aria-label="Fullname: activate to sort column ascending" style="width: 270px;">Fullname </th>
<th class="sorting" tabindex="0" aria-controls="dataTable1" rowspan="1" colspan="1" aria-label="user: activate to sort column ascending" style="width: 270px;">Username</th>
...
<tbody>
 <?php 
$query3 = mysqli_query($db, "SELECT * FROM users ORDER BY id DESC");
