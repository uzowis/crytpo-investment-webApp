...
<h6 class="element-header">Investment History</h6>
...
<thead>
<tr role="row">
<th class="sorting_asc" tabindex="0" aria-controls="dataTable1" rowspan="1" colspan="1"  style="width: 263px;">Plan</th>
...
<tbody>
 <?php 
$query3 = mysqli_query($db, "SELECT * FROM investment WHERE user_id='$id2' ORDER BY id DESC");
...
<tr class="odd">
	...
	<td><span class='badge <?php if(($details3['status'])==='Active'){echo 'badge-info';}else{echo 'badge-success';}?>'> <?php echo $details3['status']; ?></span></td>
