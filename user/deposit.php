...
<div class="col-md-8">
       <div class="element-wrapper" >
<h6 class="element-header">Fund Wallet</h6>
...
<h5 class="form-header">Deposit Funds</h5>
...
<div class="form-group row">
	...
	<div class="col-sm-8">
		  ...
		  <input class="form-control" name="amount" id="amount" placeholder="Amount to deposit"  type="number">
	</div>
</div>
...
<div class="form-group row">
	...
	<div class="col-sm-8">
	 <select style="color: black;" class="form-control form-control-rounded" required="" name="method">
...
<button class="btn btn-success" name="deposit_btn" onclick="return withdraw_auth()" type="submit"> Make Deposit</button>
</div>
</form>
</div>
</div>
