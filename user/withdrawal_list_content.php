...
<h6 class="element-header">Withdrawal History</h6>
...
<th class="sorting" tabindex="0" aria-controls="dataTable1" rowspan="1" colspan="1" aria-label="Amount ($): activate to sort column ascending" style="width: 433px;">Status ($)</th>
...
<tbody>
 ...
 <?php 
$query3 = mysqli_query($db, "SELECT * FROM withdrawal WHERE user_id='$id2' ORDER BY id DESC");
