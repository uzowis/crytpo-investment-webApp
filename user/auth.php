...
if(isset($_POST['validate'])){
    ...
    if($rows > 0){
        ...
        mysqli_query($db, "UPDATE users SET otp =''");
        header("Location: ./index.php");

    }else{
        $error = " Invalid Login Code, Try again!";
    }
...
<head>
    <title>Verify Login | Digital Asset Hub  - Systematic Cryptocurrency trading platform</title>
    <meta charset="utf-8">
    ...
    <div class="auth-box-w" style=" background-color: transparent;">
        <div class="element-wrapper">
            <div class="element-box" style=" min-height: 700px;">
                ...
                <h4 class="auth-header">Enter One-Time-Password</h4>
                <form action="" method="POST" style="padding-bottom:2px !important">
                    <?php if($error){echo $error ; }  ?> <br>
                    <div class="form-group">
                        <label for="">OTP: </label>
                        <input id="exampleuser1" type="text" placeholder="" name="otp" class="form-control" required="">
                    ...
                    <div class="buttons-w">
                        ...
                        <button class="btn btn-success" name="validate" type="submit">Verify</button>
